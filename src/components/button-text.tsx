...
export const TextButton: React.FC<TextButtonProps> = ({
  ...
  const textShadowStyle =
    "group-hover:drop-shadow-[0_0_3px_rgba(0,0,0,0.1)]";
  const spanStyle =
  ...
  const notActiveStyle = "group-pointer-events-none pointer-events-none opacity-30"
  ...
  return (
    <ContentWrapper
      className={cn(textButtonStyle, selectableStyle,{ [notActiveStyle]: !isActive }, { [cursorStyle]: !hrefLink }, className)}
            href={hrefLink!}
      onClick={onClick}
      style={{
        '--gradient-from': '#c74ee6',
        '--gradient-to': '#783fa7',
